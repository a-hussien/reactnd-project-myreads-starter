...
* #### Backend: Book Lender API from [Udacity](https://reactnd-books-api.udacity.com/)


## To get started:

* Make sure you have installed `Node.js` on your machine, if not please install it from [`Official Website`](https://nodejs.org/)
* Clone this repository
* Navigate to cloned folder 
* install all project dependencies with `npm install`
* start the development server with `npm start`

`The Browser will be render on port 3000 with url` (http://localhost:3000)
...
* Search results are limited to 20
